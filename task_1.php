...
$elements = [
    [
            "title" => "Reports",
            "dataFilterTags" => "reports file"
    ],
    [
            "title" => "Analytics",
            "dataFilterTags" => "analytics graphs"
    ],
    [
            "title" => "Export",
            "dataFilterTags" => "export download"
    ],
    [
            "title" => "Storage",
            "dataFilterTags" => "Storage"
    ]
];
?>
<!DOCTYPE html>
                                ...
                                <div class="bg-warning-100 border border-warning rounded">
                                    ...
                                    <ul id="js-list-msg" class="list-group px-2 pb-2 js-list-filter">
                                        ...
                                        <li class="list-group-item">
                                            <span data-filter-tags="<?=$element['dataFilterTags']?>"><?=$element['title']?></span>
                                        </li>
                                        <?php endforeach;?>
                                    </ul>
