                        ...
                        <div class="panel-content">
                            <div class="fs-lg fw-300 p-5 bg-white border-faded rounded mb-g">
                                <?php foreach ($items as $item):?>
                                    <h<?=$item['titleSize']?> class="<?=$item['titleClass']?>">
                                        <?=$item['titleText']?>
                                    </h<?=$item['titleSize']?>>
